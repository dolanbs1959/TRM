...
def verify():
    with sync_playwright() as p:
        ...
        # Take screenshot
        page.screenshot(path="/home/jules/verification/screenshots/home_dark_mode.png", full_page=True)
        print("Screenshot saved to /home/jules/verification/screenshots/home_dark_mode.png")
